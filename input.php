...
class Input
{
    ...
    public function format($type, $param = null)
    {
        ...
        if ($this->_format == false) $this->_format = new Input\Format();

        /** Prevent nulls from creating blank arrays */
        if ($this->_currentRecord == null) return $this;
    ...
    public function validate($action, $param = array(), $option = null)
    {
        ...
        if ($this->_validate == false) $this->_validate = new Input\Validate();
        ...
        if ($validateStatus == true) $this->_errorData[$key] = $validateStatus;
    ...
    {
        if ($key != null) {
            if (isset($this->_inputData[$key])) return $this->_inputData[$key];
            else return false;
        } else {
            /**
