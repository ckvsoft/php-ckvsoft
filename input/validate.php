...
class Validate {
    ...
    public function minlength($value, $param) {
        if (strlen($value) < $param) return "must be atleast $param in length";
    }
    ...
    public function exactlength($value, $param) {
        if (strlen($value) != $param) return "must be exactly $param in length";
    }
    ...
    public function gt($value, $param) {
        ...
        if ($value <= $param) return "must be greater than $param";
    }
    ...
    public function lt($value, $param) {
        ...
        if ($value >= $param) return "must be less than $param";
    }
    ...
    public function eq($value, $param) {
        if ($value != $param) return "does not match";
    }
    ...
    public function eqany($value, $param = array(), $caseSensitive = true) {
        ...
        if (!in_array($value, $param)) return "is not valid";
    }
    ...
    public function regex($value, $param) {
        if (!preg_match($param, $value)) return 'must match regular expression';
    }
    ...
    public function digit($value) {
        if (!is_numeric($value)) return 'must be numeric.';
    }
    ...
    public function float($value) {
        if (!is_float($value)) return 'must be a float.';
    }
    ...
    public function alpha($value) {
        if (!ctype_alpha($value)) return 'must be alphabetical only.';
    }
    ...
    public function alphanum($value) {
        if (!ctype_alnum($value)) return 'must be alphanumeric only.';
    }
    ...
    public function agemin($dob, $min = 18) {
        ...
        if ($result <= 0 || $result >= 125) return "invalid date provided";

        if ($result < $min) return "minimum age is $min";
    }
    ...
    public function agemax($dob, $max = 50) {
        ...
        if ($result > $max) return "maximum age is $max";
    }
